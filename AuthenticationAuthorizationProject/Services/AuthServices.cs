...
namespace AuthenticationAuthorizationProject.DataAccess.Services
{
    public class AuthServices : IAuthServices
    {
        ...
        public async Task<AuthModel> RegisterAsync(RegisterModel model)
        {
            ...
            await _userManager.AddToRoleAsync(user, Roles.BasicAdmin);
            ...
            return new AuthModel
            {
                ...
                Roles = new List<string> { Roles.BasicAdmin },
        ...
        public async Task<string> AddRoleAsync(AddRoleModelViewModel model)
        {
